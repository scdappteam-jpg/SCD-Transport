(function() {
    const customers = [ {
        ...
        taxId: "0105559000001",
        billingEmail: "billing@wd-demo.com",
        creditTerm: 30
    }, {
        id: "c_hua_thai",
        name: "Hua Thai Manufacturing",
        taxId: "0105559000002",
        billingEmail: "finance@huathai-demo.com",
        creditTerm: 15
    }, {
        id: "c_benchmark",
        name: "Benchmark Electronics",
        taxId: "0105559000003",
        billingEmail: "ap@benchmark-demo.com",
        creditTerm: 30
    }, {
        id: "c_michelin",
        name: "Michelin Siam Co., Ltd.",
        taxId: "0105559000004",
        billingEmail: "billing@michelin-demo.com",
        creditTerm: 30
    }, {
        id: "c_fabrinet",
        name: "Fabrinet Co., Ltd.",
        taxId: "0105559000005",
        billingEmail: "account@fabrinet-demo.com",
        creditTerm: 15
    } ];
    const addHours = hours => new Date(Date.now() + hours * 60 * 60 * 1e3).toISOString();
    ...
    const rawJobs = [ [ "JOB-DEMO-001", "4840779189", "c_wd", "TG640", 2, "PickupStarted", "Lithium", "WH3", "12", "320.5", "70-1234", "" ], [ "JOB-DEMO-002", "4840779188", "c_wd", "TG640", 2, "Pending", "Lithium", "TGINT", "4", "88.0", "70-1234", "" ], [ "JOB-DEMO-003", "4840779011", "c_hua_thai", "CX750", 6, "Inbound", "General", "WH3", "7", "797.0", "71-4567", addHours(-1) ], [ "JOB-DEMO-004", "4840778891", "c_michelin", "JL034", 9, "XRayPassed", "General", "BFS", "53", "618.0", "72-8899", addHours(-2) ], [ "JOB-DEMO-005", "4840778893", "c_michelin", "JL034", 9, "XRayPassed", "General", "BFS", "7", "66.5", "72-8899", addHours(-2) ], [ "JOB-DEMO-006", "4840778761", "c_benchmark", "EK373", 14, "Pending", "General", "WH3", "1", "136.0", "73-9012", "" ], [ "JOB-DEMO-007", "4840778251", "c_fabrinet", "SQ713", 22, "ReadyForBilling", "General", "TG", "1", "262.5", "74-0001", addHours(-5) ], [ "JOB-DEMO-008", "4840778123", "c_hua_thai", "BR068", -1, "PickupStarted", "General", "WH3", "2", "500.0", "75-1414", "" ], [ "JOB-DEMO-009", "4840777972", "c_fabrinet", "TG642", 28, "Billed", "General", "TGINT", "2", "400.0", "76-7788", addHours(-10) ], [ "JOB-DEMO-010", "4840777663", "c_benchmark", "QR837", 36, "Pending", "Lithium", "WH3", "1", "10.5", "77-9933", "" ] ];
    ...
    window.SMART_LOGISTICS_DEMO = {
        ...
        dashboard: {
            ...
            alerts: [ {
                id: "ALERT-DEMO-001",
                message: "Demo mode: loaded 10 sample jobs",
                severity: "info",
                createdAt: (new Date).toISOString()
            } ],
            metrics: {
